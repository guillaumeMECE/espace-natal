...
function mailToUser($url, $isSend)
{
	...
	if ($isSend=="true") {
		...
		$message_txt = "Bonjour " . $_POST["inputNom"] . " " . $_POST["inputPrenom"] . " votre email au cabinet Jean richepin a eu une erreur à l'envoi. Veuillez réessayer ultérieurement.";
	}
